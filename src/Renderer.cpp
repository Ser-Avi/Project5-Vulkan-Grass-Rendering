...
void Renderer::CreateComputeDescriptorSetLayout() {
    ...
    VkDescriptorSetLayoutBinding inputGrassBinding = {};
    inputGrassBinding.binding = 0;
    inputGrassBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    inputGrassBinding.descriptorCount = 1;
    inputGrassBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    inputGrassBinding.pImmutableSamplers = nullptr;

    VkDescriptorSetLayoutBinding outputGrassBinding = {};
    outputGrassBinding.binding = 1;
    outputGrassBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    outputGrassBinding.descriptorCount = 1;
    outputGrassBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    outputGrassBinding.pImmutableSamplers = nullptr;

    VkDescriptorSetLayoutBinding numGrassBinding = {};
    numGrassBinding.binding = 2;
    numGrassBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    numGrassBinding.descriptorCount = 1;
    numGrassBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    numGrassBinding.pImmutableSamplers = nullptr;

    std::vector<VkDescriptorSetLayoutBinding> bindings = { inputGrassBinding, outputGrassBinding, numGrassBinding };
...
void Renderer::CreateDescriptorPool() {
    ...
    std::vector<VkDescriptorPoolSize> poolSizes = {
        ...
        // three buffers for compute, each with number of blades size
